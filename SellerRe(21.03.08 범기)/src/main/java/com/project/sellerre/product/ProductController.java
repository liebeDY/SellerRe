...
//	      user_Service.checkNickName(u.getUser_nickname());
	...
	public ModelAndView selectProductByPrice(@RequestParam(value = "user_id") String user_id, @RequestParam(value = "searchKeyword")String searchKeyword, @RequestParam(value = "categoryName")String categoryName, @RequestParam(value = "min") int min, @RequestParam(value = "max") int max) {
        ...
        if(categoryName != null) {
        	allProdList = (ArrayList<Product>) product_Service.selectProductByPriceAndCategoryName(categoryName, min, max);
        	...
        	allProdList = (ArrayList<Product>) product_Service.selectProductByPriceAndName(searchKeyword, min, max);
        	for (int i = 0; i < allProdList.size(); i++) {
        		p = allProdList.get(i);
        		count = wish_Service.countUserIdByProductNum(p.getProduct_num());
...
//		  
//		  ModelAndView mav = new ModelAndView();
//	      System.out.println("서치키워드 컨트롤러 ======= " + searchKeyword);
//	      System.out.println("서치키워드 컨트롤러 ======= " + user_id);
//	      ArrayList<Product> list = (ArrayList<Product>) product_Service.selectProductByName(searchKeyword);
//	      ArrayList wishList = null;
//	      Wish w = null;
//	      Product wish_product = null;
//	      Product total_product = null;
//	      // 0 일때 : 빈 하트
//	      int wishType = 0;
//	      // 유저 아이디가 없을 때 : 로그인 하지 않았을 때
//	      
//	      if (user_id == null || user_id == "") {
//	    	 mav.setViewName("/product/product_list");
//	         mav.addObject("list", list);
//	         mav.addObject("wishType", wishType);
//	         System.out.println("서치키워드 컨트롤러2222222222 ======= " + user_id);
//	      } else if(u.getUser_type()==2) { 
//	    	  if(list.isEmpty()) {
//	    		  System.out.println("list 비었음");
//	    		  list.add(new Product(0, "", 0, "", 0, 0, 0, "", null, 0, 0));
//	    	  }
//	    	  System.out.println("서치키워드 컨트롤러3333333" + list);
//	    	  mav.setViewName("/admin/productJSON");
//	    	  mav.addObject("list", list);
//	      } else {
//	    	  System.out.println("컨트롤러 333333 : " + user_id );
//	    	  /**
//	    	   * 
//	    	   * 
//	    	   * 위시가 없어도 검색이 되도록 설정하기
//	    	   * 
//	    	   *  
//	    	   */
//	    	 mav.setViewName("/product/product_list"); 
//	    	 wishList = (ArrayList) wish_Service.selectByUserId(user_id);
//	    	 System.out.println("컨트롤러 44444 : " + wishList );
//	    	 if (!wishList.isEmpty()) {
//	    		 System.out.println("컨트롤러55555 : " + wishList );
//	    		 // 전체 상품 중에서
//	    		 for (int i = 0; i < list.size(); i++) {
//	    			 // 전체 상품 [i]
//	    			 total_product = list.get(i);
//	    			 
//	    			 // 위시에 담긴 상품 [i]
//	    			 w = (Wish) wishList.get(i);
//	    			 wish_product = product_Service.selectProductByNum(w.getProduct_num());
//	    			 
//	    			 // 찜한 상품이 없다면
//	    			 if (total_product != wish_product ) {
//	    				 total_product.setWish_type(0);
//	    				 
//	    				 // 찜한 상품이 있을 때   
//	    			 } else {
//	    				 total_product.setWish_type(1);
//	    			 }
//	    			 mav.addObject("list", list);
//	    		 }
//	    	 } else {
//	    		 System.out.println("위시리스트 없어용");
//	    		 mav.addObject("list", list);
//	    	 }
//	      }
//	      return mav;
