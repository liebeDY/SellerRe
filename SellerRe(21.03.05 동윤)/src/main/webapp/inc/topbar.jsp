	 ...
	 <!-- 로고 시작 -->
        ...
        <div class="top_menu_board_area">
            ...
            <a href="${pageContext.request.contextPath }/qna/mav_qna_list?qna_type=1" class="top_menu_board_item">
                <img src="${pageContext.request.contextPath }/assets/img/main_board/b_2.png" alt="아이콘 사진" class="top_menu_board_img">
            </a>

            <!-- 게시판 링크 3 -->
            <a href="${pageContext.request.contextPath }/report/mav_report_List" class="top_menu_board_item">
                <img src="${pageContext.request.contextPath }/assets/img/main_board/b_3.png" alt="아이콘 사진" class="top_menu_board_img">
            </a>
        </div>
    </div>
    <!-- 메뉴 끝 -->
