...
<%--                 <span class="product_price">${p.product_price } 원</span> --%>
                ...
                <c:if test="${p.result == 2 }">
                   <span class="product_price">거래완료</span>
                </c:if>
            </div>
            ...
            <!--  로그인된 id -->
                <input type="hidden" id="login_user_id" name="user_id" value="${sessionScope.user_id }"/>
		        ...
		        <tr>
		            <td class="review_view_seller_td" colspan="2">
		                ...
		                <div class="review_seller_info">
		                    ...
		                    <span class="seller_id">작성자 : <a class="review_user_link" href="${pageContext.request.contextPath }/user/userProfile?user_id=${p.user_id}"> ${p.user_id } </a></span>
