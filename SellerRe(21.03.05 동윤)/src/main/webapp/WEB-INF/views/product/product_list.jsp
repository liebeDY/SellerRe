        ...
        <div class="search_container">
            ...
            <form class="price" method="POST" action="${pageContext.request.contextPath }/product/selectProductByPrice">
                <div class="search_input_container">
                    ...
                    <input type="text" name="min" class="min" id="min" pattern="[0-9]+" placeholder="최소가격" />
                    <span class="and_price"> ~ </span> 
                    <input type="text" name="max" class="max" id="max" pattern="[0-9]+" placeholder="최대가격" />
...
<!--                         </div> -->
                  ...
                  <!-- 상품가격 및 삭제버튼-->
                  <!-- 가격 표시 : js에서 span의 id로 변경한다  -->
                  <div class="product_price">
                      <div class="prod_price"> 
                         <a class="prod_detail_link" href="${pageContext.request.contextPath }/product/productDetail?product_num=${i.product_num}" >
                            <span class="product_price">${i.product_price } 원</span>
                         </a>
                      </div>
                      <div>
                          <input type="button" class="delbtn" name="delbtn" id="delbtn" value="제품삭제" />
                      </div>
                  </div>
                  ...
                  <div class="product_info">
                      ...
                      <div>
                          <c:if test="${i.result == 1 }">
                                <input type="text" value="거래중"/>
                          </c:if>
                          
                          <c:if test="${i.result == 2 }">
                                <input type="text" value="거래완료"/>
                          </c:if>
                      </div>
                  </div>
