...
// 		    location.href="${pageContext.request.contextPath}/report/mav_report_List";
    	});
        ...
        <table>
            <tr>
                ...
                <td class="reportTitle_text_td">
                    <input class="reportTitle_text" name="report_title" type="text" placeholder="제목을 입력하세요.">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="textArea_td">
                    <textarea class="reportContent_text" name="report_content" placeholder="내용을 입력하세요."></textarea>
                </td>
            </tr>
