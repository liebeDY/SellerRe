   ...
   <c:import url="${pageContext.request.contextPath }/inc/topbar.jsp" />
    ...
    <div class="main_banner_container">
       <div class="bx-viewport">
          <ul class="slider">
            <li>
               <img class="slider_img" src="${pageContext.request.contextPath }/assets/img/banner3.png" />
            </li>
            
            <li>
               <img class="slider_img" src="${pageContext.request.contextPath }/assets/img/banner2.png" />
            </li>
                        
            <li>
               <img class="slider_img" src="${pageContext.request.contextPath }/assets/img/banner1.png" />
            </li>
         </ul>
       </div>
    </div>
