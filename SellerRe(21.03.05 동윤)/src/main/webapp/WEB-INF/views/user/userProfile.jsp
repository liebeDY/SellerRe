		...
		$(document).ready(function() {
			...
			$(".score_btn").click(function() {
	         ...
	         $(".result_btn").click(function(){
	            var result = this.form.result.value;
...
<%--     <c:import url="${pageContext.request.contextPath }/product/product_list" /> --%>
	...
	<c:if test="${not empty myProductList }">
	            ...
	            <div class="product_info_area">
	                ...
	                <div class="product_info">
	                    <div class="prod_info"> 
	                        ...
	                        <div>
	                        	<c:if test= "${sessionScope.user_id == i.user_id }">
		                            <input type="button" class="result_btn" value="거래완료" />
		                        </c:if>
	                        </div>
	                    </div>
	        ...
	        <input type="hidden" class="result" name="result" value="${i.result }" />
	        <hr />
	    </form>
    		</c:forEach>
  </c:if>
